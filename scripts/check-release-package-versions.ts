...
export function validateReleasePackageVersions(input: { rootManifest: unknown; cliManifest: unknown; coreManifest: unknown; serverManifest: unknown; uiManifest: unknown; lockfile: unknown; releaseConfig: unknown }): void {
  ...
  if (!Array.isArray(coreExtraFiles) || coreExtraFiles.length !== 7) throw new Error("Release Please Core package must declare exactly seven dependency updaters");
